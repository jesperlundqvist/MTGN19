...
const MediaImg = props => {
  ...
  return (
    <div className='media-img' style={{transform: `rotate(${(Math.random() * 8) -4}deg)`}}>
            ...
            <g transform="matrix(0.957907,0,0,1.04697,49.4719,-20.2428)">
              ...
              <g transform='matrix(1.01753,0,0,1.01753,-909.653,30.7795)'>
                <text
                  ...
                  {props.media.event.name}
                </text>
              </g>
              <g id="play_icon" transform="matrix(2.36845,0,0,2.36845,443.419,279.419)">
                <use xlinkHref="#_Image_play" x="0" y="0" width="128px" height="128px"/>
            </g>
            </g>
          </g>
          <defs>
      ...
      {/*<div className="media-img" style={{backgroundImage: `url('${thumbnail}')`}}>
            {(props.media.type ===  "video") ? <img src="/static/images/play_icon.png" alt="hej"/> : null}
    </div>*/}
    </div>
  );
};
